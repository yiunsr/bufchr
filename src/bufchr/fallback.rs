...
pub fn bufchrfast3(haystack: &[u8], n1: u8, n2: u8, n3: u8, vector_end_ptr: *const u8) -> (Option<usize>, u64, u64) {
    (haystack.iter().position(|&b| b == n1 || b == n2 || b == n3), 0, 0)
}
pub fn bufchrfast3_raw(haystack: &[u8], n1: u8, n2: u8, n3: u8) -> Option<usize> {
    haystack.iter().position(|&b| b == n1 || b == n2 || b == n3)
}
